...
# Lookbook is the component browser exposed at /lookbook. This starter app
# intentionally serves it in production so visitors can explore every
# solrengine-ui component with live previews.
gem "lookbook"
